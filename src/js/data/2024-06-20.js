dataSetVersion = "2024-03-22"; // Change this when creating a new data set version. YYYY-MM-DD format.
...
dataSet[dataSetVersion].characterData = [
  ...
  {
    name: "Opening (Tricolor Turf War)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc'],
  ...
  {
    name: "Opening (Splatoween Tricolor Turf War)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc'],
  ...
  {
    name: "Opening (FrostyFest Tricolor Turf War)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc'],
  ...
  {
    name: "Anarchy Rainbow (SpringFest)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc']
  ...
  {
    name: "Opening (SpringFest Tricolor Turf War)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc'],
  ...
  {
    name: "Anarchy Rainbow (Summer Nights)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc']
  ...
  {
    name: "Opening (Summer Nights Tricolor Turf War)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc'],
  ...
  {
    name: "Ego Overboard (Summer Nights)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc']
  ...
  {
    name: "Still Swimmin' (Summer Nights)",
    img: "Dh2K8rG.png",
    opts: {
      game: ['s3'],
      band: ['dc']
